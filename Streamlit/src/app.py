...
pickle_in1 = open("./src/model22.pkl",'rb')
...
image = Image.open('./src/sales.png')
...
if project and project != "None":
    if project == "Time Series problem":
        ...
        if st.button("Predict"):
            results = run_regression (date, dcoilwitco , id,promotion,store_nbr, transactions)
            # st.write = (f"your predicted result is :{date}, {results}")
            print(results)
